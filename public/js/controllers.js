...
angular.module('acadb.controllers', [])
	...
	.controller('PasswordCtrl', function ($scope, $http, $state, $auth, CSRF_TOKEN, $stateParams) {
		$scope.postPasswordEmail = function(){
			$http.post('api/password/email', { email:$scope.user.email	})
				.then(function(data){
					$state.go('login');
				})
		...
		$scope.getPasswordReset = function(){
			$http.get('api/password/email/' + CSRF_TOKEN , {email:$scope.user.email})
				.then(function(data){
					//$state.go('login');
				})
		...
		$scope.postPasswordReset = function(){
			$http.post('api/password/reset', { email:$scope.user.email,
